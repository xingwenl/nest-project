...
import { Controller, Get, Injectable, Query, Post, Body, Req, LoggerService } from '@nestjs/common';
...
export class StorageController {
    ...
    @Get('/get') 
    @JwtAuth()
    get(@Query('size') size: number, @Query('page') page: number, @Query('key') key?: string, @Req() req?: any){
